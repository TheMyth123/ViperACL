...
class PathfinderCoordinator:
    ...
    def find_path(self, source_name, target_name, mode="tactical", ml_model=None, max_hops=15, ml_threshold=0.50, project_id=None):
        """
        ...
        if mode == "fasttrack":
            ...
            return run_predictive(self.db, source_name, target_name, ml_model, max_hops=max_hops, ml_threshold=ml_threshold, project_id=project_id) 
